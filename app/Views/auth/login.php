        ...
        <div class="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" id="password" name="password" class="w-full p-3 border border-gray-300 rounded mt-2" >
                    <small class="text-red-500"><?php echo $errors['password'] ?? '' ; ?></small>

                </div>
                <button type="submit" name="submit" class="w-full bg-fuchsia-800 text-white py-3 px-6 rounded hover:bg-fuchsia-600 transition">Login</button>
            </form>
